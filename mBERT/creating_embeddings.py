...
# Load your dataset
df = pd.read_csv('modified_whole_data.csv')  # Adjust the file name as necessary

# Generate embeddings for the current subset
embeddings = generate_embeddings(df)

# Save embeddings to a .pkl file
with open('BERT_whole_embeddings.pkl', 'wb') as f:
    pickle.dump(embeddings, f)

print(f"Embeddings saved to 'BERT_whole_embeddings.pkl'")
