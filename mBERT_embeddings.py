...
# Load your dataset
df = pd.read_csv(r'val_data.csv')  # Adjust the file name as necessary

# Generate embeddings for the current subset
embeddings = generate_embeddings(df)

# Save embeddings to a .pkl file
with open('mBERT_val_embeddings.pkl', 'wb') as f:
    pickle.dump(embeddings, f)

print(f"Embeddings saved to 'mBERT_val_embeddings.pkl'")
